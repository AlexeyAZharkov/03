class DeltaClock:
    ...
    def __str__(self):
        ...
        if dif > 0:
            h = str(dif//3600) if dif//3600 > 9 else f'0{dif//3600}'
            m = str(dif%3600//60) if dif%3600//60 > 9 else f'0{dif%3600//60}'
            s = str(dif%3600%60) if dif%3600%60 > 9 else f'0{dif%3600%60}'
            return f'{h}: {m}: {s}'
        else:
            return 0
...
dt = DeltaClock(Clock(21, 16, 0), Clock(1, 15, 0))
print(dt) # 01: 30: 00
len_dt = len(dt) # 5400
print(len_dt)
