...
class DataBase:
    ...
    def read(self, pk):
        for rec in self.dict_db.values():
            for i in rec:
                if i.pk == pk:
                    return i
...
# lst_in = ['Балакирев С.М.; программист; 33', 'Балакирев С.М.; программист; 33', 'Балакирев С.М.; преподаватель; 37']
# lst_in = ['Балакирев С.М.; программист; 33', 'Кузнецов А.В.; разведчик-нелегал; 35', 'Суворов А.В.; полководец; 42',
#           'Иванов И.И.; фигурант всех подобных списков; 26', 'Балакирев С.М.; преподаватель; 37']
...
read(self, pk) - чтение записи из БД (возвращает объект Record) по ее уникальному идентификатору pk (уникальное целое положительное число).
