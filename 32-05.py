...
'''
Предположим, мы разрабатываем класс для обработки формы авторизации на стороне сервера. Для этого был создан, 
...
CharsValidator - для проверки допустимых символов из переданных в виде строки набора символов.
